...
class Config:
    ...
    ECONOMIC_INDICATORS = {  # 各国核心宏观经济指标配置（代码 -> 元信息）
        ...
        # ---- 利率与财政 ----
        'FED_FUNDS_RATE':        {'name': 'FOMC利率决策(下限)', 'country': '美国', 'category': '利率与财政', 'unit': '%',    'frequency': 'per_fomc'},
        'FED_FUNDS_RATE_UPPER':  {'name': 'FOMC利率决策(上限)', 'country': '美国', 'category': '利率与财政', 'unit': '%',    'frequency': 'per_fomc'},
        'GOVERNMENT_BUDGET':     {'name': '政府预算',           'country': '美国', 'category': '利率与财政', 'unit': '亿美元', 'frequency': 'monthly'},
        # ---- 通胀 ----
        'CPI_YOY':                           {'name': 'CPI同比',              'country': '美国', 'category': '通胀', 'unit': '%', 'frequency': 'monthly'},
        'CPI_MOM':                           {'name': 'CPI月率',              'country': '美国', 'category': '通胀', 'unit': '%', 'frequency': 'monthly'},
        'CORE_CPI_MOM':                      {'name': '核心CPI月率',          'country': '美国', 'category': '通胀', 'unit': '%', 'frequency': 'monthly'},
        'CORE_CPI_YOY':                      {'name': '核心CPI同比',          'country': '美国', 'category': '通胀', 'unit': '%', 'frequency': 'monthly'},
        'CORE_PCE_YOY':                      {'name': '核心PCE年率',          'country': '美国', 'category': '通胀', 'unit': '%', 'frequency': 'monthly'},
        'CORE_PCE_MOM':                      {'name': '核心PCE物价指数环比',  'country': '美国', 'category': '通胀', 'unit': '%', 'frequency': 'monthly'},
        'PCE_YOY':                           {'name': 'PCE物价指数同比',      'country': '美国', 'category': '通胀', 'unit': '%', 'frequency': 'monthly'},
        'PCE_MOM':                           {'name': 'PCE物价指数环比',      'country': '美国', 'category': '通胀', 'unit': '%', 'frequency': 'monthly'},
        'PPI_YOY':                           {'name': 'PPI同比',              'country': '美国', 'category': '通胀', 'unit': '%', 'frequency': 'monthly'},
        'MICHIGAN_5Y_INFLATION_EXPECTATION': {'name': '密歇根大学5年通胀预期', 'country': '美国', 'category': '通胀', 'unit': '%', 'frequency': 'monthly'},
        'MICHIGAN_1Y_INFLATION_EXPECTATION': {'name': '密歇根大学1年通胀预期', 'country': '美国', 'category': '通胀', 'unit': '%', 'frequency': 'monthly'},
        # ---- 就业 ----
        'NONFARM_PAYROLL':        {'name': '非农就业新增',         'country': '美国', 'category': '就业', 'unit': '万人', 'frequency': 'monthly'},
        'UNEMPLOYMENT_RATE':      {'name': '失业率',               'country': '美国', 'category': '就业', 'unit': '%',   'frequency': 'monthly'},
        'INITIAL_JOBLESS_CLAIMS': {'name': '首次申请失业救济人数', 'country': '美国', 'category': '就业', 'unit': '万人', 'frequency': 'weekly'},
        'ADP_EMPLOYMENT_CHANGE':  {'name': 'ADP就业人数变动',      'country': '美国', 'category': '就业', 'unit': '万人', 'frequency': 'monthly'},
        'JOLTS_JOB_OPENINGS':     {'name': 'JOLTS职位空缺',        'country': '美国', 'category': '就业', 'unit': '万人', 'frequency': 'monthly'},
        # ---- 经济增长 ----
        'GDP_QOQ':                {'name': 'GDP季环比', 'country': '美国', 'category': '经济增长', 'unit': '%', 'frequency': 'quarterly'},
        # ---- 景气调查 ----
        'ISM_MFG_PMI':           {'name': 'ISM制造业PMI',      'country': '美国', 'category': '景气调查', 'unit': '', 'frequency': 'monthly'},
        'ISM_NON_MFG_PMI':       {'name': 'ISM非制造业指数',   'country': '美国', 'category': '景气调查', 'unit': '', 'frequency': 'monthly'},
        'SP_GLOBAL_MFG_PMI':     {'name': '标普全球制造业PMI', 'country': '美国', 'category': '景气调查', 'unit': '', 'frequency': 'monthly'},
        'SP_GLOBAL_SVC_PMI':     {'name': '标普全球服务业PMI', 'country': '美国', 'category': '景气调查', 'unit': '', 'frequency': 'monthly'},
        'NY_FED_MFG_INDEX':      {'name': '纽约联储制造业指数', 'country': '美国', 'category': '景气调查', 'unit': '', 'frequency': 'monthly'},
        'RICHMOND_FED_MFG_INDEX':{'name': '里士满联储制造业指数','country': '美国', 'category': '景气调查', 'unit': '', 'frequency': 'monthly'},
        # ---- 消费与投资 ----
        'RETAIL_SALES_MOM':         {'name': '零售销售月率',    'country': '美国', 'category': '消费与投资', 'unit': '%',   'frequency': 'monthly'},
        'DURABLE_GOODS_ORDERS_MOM': {'name': '耐用品订单环比',  'country': '美国', 'category': '消费与投资', 'unit': '%',   'frequency': 'monthly'},
        'EXISTING_HOME_SALES':      {'name': '成屋销售总数年化','country': '美国', 'category': '消费与投资', 'unit': '万户', 'frequency': 'monthly'},
        'CONSUMER_CONFIDENCE':      {'name': '消费者信心指数', 'country': '美国', 'category': '消费与投资', 'unit': '', 'frequency': 'monthly'},
        # ---- 能源 ----
        'EIA_GASOLINE_INVENTORY_CHANGE':  {'name': 'EIA汽油库存变动', 'country': '美国', 'category': '能源', 'unit': '万桶', 'frequency': 'weekly'},
        'EIA_CRUDE_OIL_INVENTORY_CHANGE': {'name': 'EIA原油库存变动', 'country': '美国', 'category': '能源', 'unit': '万桶', 'frequency': 'weekly'},
        # 中国宏观指标：FRED 不提供中国数据，仅通过 wscn 日历数据源同步
        # 分类参照 wscn_indicators_updated.xlsx：盈利基本面/流动性与信用/外贸与外部/消费与投资/景气预期
        # ---- 盈利基本面 ----
        'CN_GDP_YOY':                       {'name': 'GDP同比',                    'country': '中国', 'category': '盈利基本面',   'unit': '%',    'frequency': 'quarterly'},
        'CN_GDP_CUM_YOY':                   {'name': 'GDP累计同比',                'country': '中国', 'category': '盈利基本面',   'unit': '%',    'frequency': 'quarterly'},
        'CN_CPI_YOY':                       {'name': 'CPI同比',                    'country': '中国', 'category': '盈利基本面',   'unit': '%',    'frequency': 'monthly'},
        'CN_PPI_YOY':                       {'name': 'PPI同比',                    'country': '中国', 'category': '盈利基本面',   'unit': '%',    'frequency': 'monthly'},
        'CN_URBAN_UNEMPLOYMENT':            {'name': '城镇调查失业率',             'country': '中国', 'category': '盈利基本面',   'unit': '%',    'frequency': 'monthly'},
        'CN_INDUSTRIAL_PROFIT_YOY':         {'name': '规模以上工业企业利润同比',   'country': '中国', 'category': '盈利基本面',   'unit': '%',    'frequency': 'monthly'},
        'CN_INDUSTRIAL_VALUE_ADDED_YOY':    {'name': '规模以上工业增加值同比',     'country': '中国', 'category': '盈利基本面',   'unit': '%',    'frequency': 'monthly'},
        ...
        'CN_NEW_RMB_LOANS_CUM':{'name': '新增人民币贷款累计',      'country': '中国', 'category': '流动性与信用', 'unit': '亿元', 'frequency': 'monthly'},
        # 'CN_SOCIAL_FINANCING': {'name': '社会融资规模增量',        'country': '中国', 'category': '流动性与信用', 'unit': '亿元', 'frequency': 'monthly'},
        'CN_SOCIAL_FINANCING_CUM': {'name': '社会融资规模增量累计','country': '中国', 'category': '流动性与信用', 'unit': '亿元', 'frequency': 'monthly'},
        'CN_LPR_1Y':           {'name': '一年期贷款市场报价利率',  'country': '中国', 'category': '流动性与信用', 'unit': '%',    'frequency': 'monthly'},
        'CN_LPR_5Y':           {'name': '五年期贷款市场报价利率',  'country': '中国', 'category': '流动性与信用', 'unit': '%',    'frequency': 'monthly'},
        ...
        # ---- 外贸与外部 ----
        'CN_EXPORT_YOY_USD':       {'name': '出口同比(按美元计)',     'country': '中国', 'category': '外贸与外部', 'unit': '%',    'frequency': 'monthly'},
        'CN_IMPORT_YOY_USD':       {'name': '进口同比(按美元计)',     'country': '中国', 'category': '外贸与外部', 'unit': '%',    'frequency': 'monthly'},
        'CN_EXPORT_YOY_CNY':       {'name': '出口同比(按人民币计)',   'country': '中国', 'category': '外贸与外部', 'unit': '%',    'frequency': 'monthly'},
        'CN_IMPORT_YOY_CNY':       {'name': '进口同比(按人民币计)',   'country': '中国', 'category': '外贸与外部', 'unit': '%',    'frequency': 'monthly'},
        ...
        'CN_FX_RESERVES':          {'name': '外汇储备',               'country': '中国', 'category': '外贸与外部', 'unit': '亿美元', 'frequency': 'monthly'},
        'CN_SWIFT_CNY_SHARE':      {'name': 'Swift人民币在全球支付中占比', 'country': '中国', 'category': '外贸与外部', 'unit': '%', 'frequency': 'monthly'},
        # ---- 消费与投资 ----
        'CN_URBAN_FIXED_ASSET_INVEST_YOY': {'name': '城镇固定资产投资同比',     'country': '中国', 'category': '消费与投资', 'unit': '%', 'frequency': 'monthly'},
        'CN_REAL_ESTATE_INVEST':           {'name': '房地产开发投资同比',       'country': '中国', 'category': '消费与投资', 'unit': '%', 'frequency': 'monthly'},
        'CN_RETAIL_SALES_YOY':             {'name': '社会消费品零售总额同比',   'country': '中国', 'category': '消费与投资', 'unit': '%', 'frequency': 'monthly'},
        'CN_RETAIL_SALES_CUM_YOY':         {'name': '社会消费品零售总额累计同比','country': '中国', 'category': '消费与投资', 'unit': '%', 'frequency': 'monthly'},
        # ---- 景气预期 ----
        'CN_OFFICIAL_MFG_PMI':     {'name': '官方制造业PMI',     'country': '中国', 'category': '景气预期', 'unit': '', 'frequency': 'monthly'},
        'CN_OFFICIAL_NON_MFG_PMI': {'name': '官方非制造业PMI',   'country': '中国', 'category': '景气预期', 'unit': '', 'frequency': 'monthly'},
        'CN_RATINGDOG_MFG_PMI':    {'name': 'RatingDog制造业PMI', 'country': '中国', 'category': '景气预期', 'unit': '', 'frequency': 'monthly'},
        'CN_RATINGDOG_SVC_PMI':    {'name': 'RatingDog服务业PMI', 'country': '中国', 'category': '景气预期', 'unit': '', 'frequency': 'monthly'},
